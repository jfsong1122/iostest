...
#import <VEInstall/VEInstallConfig.h>
#import <VEInstall/VEInstallRegisterResponse.h>
#import <VEInstall/VEInstallNotificationConstants.h>

NS_ASSUME_NONNULL_BEGIN

/*
 提供Notification的方式获取注册/激活结束状态
...
{
    VEInstallNotificationKeyAppID :AppID,
    VEInstallNotificationKeyIsActivated : BOOL值
 }
 */
FOUNDATION_EXTERN NSString *const VEInstallDidRegisterDeviceNotification; // 注册完成通知
FOUNDATION_EXTERN NSString *const VEInstallDidActivateDeviceNotification; // 激活完成通知
...
/// 启动设备激活
/// @note 调用registerDevice会自动进行设备激活操作，通常无需调用该接口
- (void)activateDevice;
